...
# Fork of the stock Dogebox-WG "core" pup (v0.0.10) for the PUBLIC testnet3 network.
# Changes vs stock: -testnet=1, -dbcache=800 (memory-capped; no txindex, wallet already
# disabled in stock). Everything else is identical to stock.
let
